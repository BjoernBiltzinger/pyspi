# -*- coding: utf-8 -*-
#
# pySPI documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pySPI.tex', u'pySPI Documentation',
     u'Thomas Siegert, J. Michael Burgess', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyspi', u'pySPI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pySPI', u'pySPI Documentation',
     author, 'pySPI', 'One line description of project.',
     'Miscellaneous'),
]
